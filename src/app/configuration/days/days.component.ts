			...
			this.dtOptions = {
				...
				columns: [{
					...
					render: function (data: any, type: any, full: any) {
						...
						return '<button type="button" class="btn btn-outline-primary btn-sm" view-user-id="'+ciphertext+'"><i class="fas fa-edit"></i> Editar</button>';
					}
				}, {
					data: 'id',
					orderable:false, 
					...
					render: function (data: any, type: any, full: any) {
						var ciphertext = CryptoJS.AES.encrypt(data, 'secret key 123').toString();
						return '<button type="button" class="btn btn-outline-danger btn-sm" view-user-id="'+ciphertext+'"><i class="fas fa-trash"></i> Eliminar</button>';
					}
				}],
			};
