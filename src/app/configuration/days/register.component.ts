...
/**
 * Componente de configuración que permite registrar los dias laborales.
 *
 * @export
 * @class DaysRegisterComponent
 * @implements {OnInit}
 */
...
export class DaysRegisterComponent implements OnInit {
	 ...
	 * @memberOf DaysRegisterComponent
	 */
	 ...
	 * Redirige a la vista de dias laborales.
	 *
	 * @memberOf DaysRegisterComponent
	 */
	onBack() {
