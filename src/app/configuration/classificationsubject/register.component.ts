...
/**
 * Componente de configuración que permite registrar la clasifiación de asignatura
 *
 * @export
 * @class ClassificationSubjectRegisterComponent
 * @implements {OnInit}
 */
@Component({
...
export class ClassificationSubjectRegisterComponent implements OnInit {
	 ...
	 * @memberOf ClassificationSubjectRegisterComponent
	 */
	public title: string;
	...
	/**
	 * @method onBack
	 * @description Método que permite volver a la vista de clasificación de asignatura.
	 * Redirige a la vista de clasificación de asignatura.
	 *
	 * @memberOf ClassificationSubjectRegisterComponent
	 */
	onBack() {
