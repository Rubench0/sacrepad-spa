...
/**
 * Componente de control de estudio que permite editar los facilitadores.
 *
 * @export
 * @class FacilitatorsEditComponent
 * @implements {OnInit}
 */
@Component({
...
export class FacilitatorsEditComponent implements OnInit {
	 ...
	 * @memberOf FacilitatorsEditComponent
	 */
	public title: string;
	public user: User;
	 ...
	 * Una vez comprobado que existe el paramentro id, Se asinga un arreglo con los roles que seran cargados en el select de la vista, creamos una instancia del objeto User.
